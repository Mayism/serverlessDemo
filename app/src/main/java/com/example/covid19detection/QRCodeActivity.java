...
public class QRCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView mImageView = (ImageView) findViewById(R.id.qrimage);
        Bitmap mBitmap = QRCodeUtil.createQRCodeBitmap("https://www.baidu.com", 480, 480,"UTF-8", "H", "2", Color.BLACK, Color.BLACK);
